...
<head>
  ...
  <style type="text/css">
.bg-register-image {
    background: url(Dashboard/img/register.png);
          ...
          <div class="col-lg-7">
            <div class="p-5">
              <div class="text-center">
                <h1 class="h4 text-gray-900 mb-4">Crear Cuenta!</h1><br>
              </div>
              <form class="user">
                <div class="form-group row">
                  ...
                  <div class="col-sm-6">
                    <input type="text" class="form-control form-control-user" id="exampleLastName" placeholder="Edad">
                  </div>
                </div>
              ...
              <hr>
              <div class="text-center">
                <a class="small" href="forgot-password.html">Recuper Contraseña?</a>
              </div>
              <div class="text-center">
